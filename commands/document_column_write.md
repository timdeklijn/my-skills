---
description: "Write subtask: interpret scan findings and produce the final standardized SQL Server column documentation file for the <TABLE> table"
subtask: true
---
